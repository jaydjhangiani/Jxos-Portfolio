    ...
    return (
        <section id="large" className=" noSelect relative py-10 cursor-pointer border border-grey bg-color-whitsemoke rounded-xl shadow-xl my-10">
            ...
            <div className="absolute top-[280px]  left-2 w-[290px]  bg-black p-5 rounded-xl">
                ...
                <button className="text-sm hover:text-white hover:bg-gray-900 px-4 py-1 rounded-lg mt-5 bg-white text-black active:scale-90 transition duration-150">{buttonText}</button>
            </div>
        </section>
    )
}
